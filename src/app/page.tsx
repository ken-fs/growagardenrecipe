...
// 像素艺术风格的食谱数据 - 基于最新 Grow a Garden 游戏
const pixelRecipes = [
  {
    id: "soup",
    title: "Soup",
  ...
  },
  {
    ...
    cookTime: "~12 minutes",
    rarity: "DIVINE",
    mainRecipe: "Tortilla x1, Rice x1, Bean x1, Cheese x1",
    alternativeRecipes: "+16 more",
    ingredients: ["Tortilla x1", "Rice x1", "Bean x1", "Cheese x1"],
    rarityColor: "bg-orange-500",
    variants: 17,
  },
  {
  ...
  },
  {
    ...
    cookTime: "~25 minutes",
    rarity: "LEGENDARY",
    mainRecipe: "Egg x3, Cream x1, Pastry x1",
    alternativeRecipes: "+22 more",
    ingredients: ["Egg x3", "Cream x1", "Pastry x1"],
    rarityColor: "bg-orange-600",
    variants: 23,
  },
  {
    ...
    cookTime: "~18 minutes",
    rarity: "RARE",
    mainRecipe: "Flour x1, Egg x1, Berry x2",
    alternativeRecipes: "+11 more",
    ingredients: ["Flour x1", "Egg x1", "Berry x2"],
    rarityColor: "bg-blue-500",
    variants: 12,
  },
  {
